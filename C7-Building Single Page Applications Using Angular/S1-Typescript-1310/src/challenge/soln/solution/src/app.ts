const url: string = "http://localhost:3000/fruits";
const fruitBasket: HTMLElement | null = document.getElementById("fruitBasket");
...
function transform(data: any) {
    fruitBasket?.replaceChildren();
    data.forEach((element: Fruit) => {
        showFruit(element);
    });
...
function showFruit(fruit: Fruit) {
    ...
    let fruitCard: HTMLElement = document.createElement("div");
    ...
    fruitBasket?.appendChild(fruitCard);
}
