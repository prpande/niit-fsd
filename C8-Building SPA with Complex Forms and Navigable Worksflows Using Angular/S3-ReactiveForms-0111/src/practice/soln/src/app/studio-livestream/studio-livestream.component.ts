...
export class StudioLivestreamComponent implements OnInit {
  ...
  get eventTitle() { return this.liveStreamForm.get('eventTitle'); }
  get eventDate() { return this.liveStreamForm.get('eventDate'); }
  get fromTime() { return this.liveStreamForm.get('fromTime'); }
  get toTime() { return this.liveStreamForm.get('toTime'); }
  get description() { return this.liveStreamForm.get('description'); }
  get guests() { return this.liveStreamForm.get('guests'); }

  ngOnInit(): void {
    this.liveStreamForm.controls['guests'].valueChanges.subscribe(
      (guestEmails) => {
  ...
  onSubmit() {
    ...
    this.liveStreamService.addLiveStreamEvent(liveStream).subscribe({
      ...
      error: err => {
        this._snackBar.open("Failed to register event!! Please Try Again Later",
          'Failure',
